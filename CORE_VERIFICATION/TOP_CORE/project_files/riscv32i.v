...
core_coverage u_core_coverage (
    ...
    // ALU coverage
    .single_instruction (Single_Instruction_stage1),
    .alu_result_1       (alu_result_1),
    .alu_result_2       (alu_result_2),
    .branch_taken       (branch_inst_wire),
    .jump_taken         (jump_inst_wire),
    .reg_write          (write_reg_file_wire)
);
